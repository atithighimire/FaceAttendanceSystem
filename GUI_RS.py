...
window.configure(background='RosyBrown1')
...
def take_img():
    try:
        ...
        stat = 'Camera is loading !!!!!'
        Notification.configure(text=stat, bg="OrangeRed2", width=23)
        Notification.place(x=500, y=400)
        Enrollment = txt.get()
        Name = txt2.get()
        path = 'C:/Users/prami/Desktop/Attendace_management_system/Datasets/' + Enrollment + ' ' + Name
        new_path = 'C:/Users/prami/Desktop/Attendace_management_system/Datasets/' + Enrollment + ' ' + Name + '/'
        os.mkdir(path)
        sampleNum = 0
        ...
        res = "Images Saved for Enrollment : " + EnterID + " Name : " + Name
...
message = tk.Label(window, text="Face Attendance  System", bg="SpringGreen3", fg="white", width=50,
